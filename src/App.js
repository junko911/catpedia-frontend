      ...
      <BrowserRouter>
        <div className="container">
          ...
          <div className="gallery">
            ...
            <Route path="/favorites" render={() => <Favorite users={this.state.users} current_user={this.state.user} followHandler={this.followHandler} unFollowHandler={this.unFollowHandler}/>} />
